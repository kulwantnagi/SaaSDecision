...
export default function ImplementationLeadPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto py-8 space-y-8">
      ...
      {submitted ? (
        <div className="bg-white border border-[#16a34a]/30 p-5 sm:p-8 rounded-3xl text-center space-y-3 shadow-sm">
          <span className="text-3xl block">✅</span>
          <h3 className="text-lg sm:text-xl font-bold text-[#0f172a]">Inquiry Received</h3>
          <p className="text-xs text-[#475569] font-medium">
            Our engineering team will review your software replacement requirements and contact you within 24 hours.
          </p>
        </div>
      ) : (
        <form onSubmit={handleSubmit} className="bg-white border border-[#e2e8f0] p-5 sm:p-8 rounded-3xl space-y-6 shadow-sm">
