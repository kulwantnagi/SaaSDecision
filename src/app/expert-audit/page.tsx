...
export default function ExpertAuditPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto py-8 space-y-8">
      ...
      {order ? (
        <div className="bg-white border border-[#16a34a]/30 p-8 rounded-3xl text-center space-y-4 shadow-sm">
          <span className="text-4xl block">💳</span>
          <h3 className="text-xl font-bold text-[#0f172a]">Order Initialized ({order.provider})</h3>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-block bg-[#16a34a] hover:bg-[#15803d] text-white font-bold px-6 py-3.5 rounded-2xl text-sm transition shadow-md shadow-[#16a34a]/25"
          >
            Proceed to Payment Checkout ↗
          </a>
        </div>
      ) : (
        <form onSubmit={handleCreateOrder} className="bg-white border border-[#e2e8f0] p-8 rounded-3xl space-y-6 shadow-sm">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-4">
              <button
                ...
                className={`flex-1 py-3.5 rounded-2xl border text-xs font-bold transition ${
          ...
          <button
            type="submit"
            className="w-full bg-[#16a34a] hover:bg-[#15803d] text-white font-bold py-4 rounded-2xl text-sm transition shadow-md shadow-[#16a34a]/25"
          >
